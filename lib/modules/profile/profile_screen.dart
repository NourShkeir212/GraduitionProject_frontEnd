                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                NameAndEditProfileSection(
                                  ...
                                  onPressed: () async {
                                    var response = await Navigator.push(context,
                                        MaterialPageRoute(builder: (context) => EditProfileScreen(profileModel: cubit.profileModel!)));
                                    if (response == "updated") {
                                      cubit.getProfile();
                                      if (kDebugMode) {
                                ...
                                ProfileDataSection(
                                  isDark:isDark,
                                  title:lang=="en" ? "+963 ${cubit.profileModel!.data!.phone!}" : "${cubit.profileModel!.data!.phone!} 963+ ",
                                  icon: Icons.phone_android,
                                ),
                                ProfileDataSection(
                                  isDark:isDark,
                                  title: cubit.profileModel!.data!.gender!.translate(context),
